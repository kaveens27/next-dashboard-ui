    ...
    return (
      <div className = 'h-screen flex'> {/* div for the whole page */}
        <div className="w-[14%] md:w-[8%] lg:w-[16%] xl:w-[14%] p-4">{/* left hand side sidebar div - creates resonsiveness using tailwind css*/}
          <Link href="/" className="flex items-center justify-center lg:justify-start gap-2"> {/* Creating the logo link to root page */}
            <Image src="/logo.png" alt='logo' width={32} height={32}/> {/* Creating the logo image */}
            <span className="hidden lg:block">SchoolTool</span> {/* Creating name to be displaed for larger screens and hides otherwise*/}
          </Link>
