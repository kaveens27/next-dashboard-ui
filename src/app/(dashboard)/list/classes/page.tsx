...
const ClassesListPage = () => {
    const renderRow = (item:Class) => { //this has (item:Teacher) as it says the type of data in the component is of structure Teacher
        return (
      ...
      return (
        <div className='bg-white p-4 rounded-md flex-1 m-4 mt-0'>
          ...
          {/* LIST SECTION */}
          <Table headerData={headerColumnData} renderRow={renderRow} rowData={classesData}/> {/* propname:{data} */}
          {/* PAGINATION SECTION */}
          <Pagination/>
        </div>
      )
