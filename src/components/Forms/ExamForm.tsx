// DESC: This will be the specific ExamForm component which will be rendered in the teacher page via the FormModal component
...
// START
const ExamForm = ({type,data}:ExamFormProps) => {
    ...
    return (
        <form className='flex flex-col p-4 gap-4' onSubmit={onSubmit}>
            <h1 className='text-xl font-semibold mb-4'>{type ==='create' ? "Create A New Exam" : "Update A Exam" }</h1>
