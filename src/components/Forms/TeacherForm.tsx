// DESC: This will be the specific TeacherForm component which will be rendered in the teacher page via the FormModal component
...
const TeacherForm = ({type,data}:TeacherFormProps) => {
    ...
    return (
        <form className='flex flex-col p-4 gap-4' onSubmit={onSubmit}>
            <h1 className='text-xl font-semibold mb-4'>Create A New Teacher</h1>
