// DESC: This will be the specific ResultForm component which will be rendered in the teacher page via the FormModal component
...
const ResultForm = ({type,data}:ResultFormProps) => {
    ...
    return (
        <form className='flex flex-col p-4 gap-4' onSubmit={onSubmit}>
            <h1 className='text-xl font-semibold mb-4'>{type ==='create' ? "Create A New Result" : "Update A Result" }</h1>
