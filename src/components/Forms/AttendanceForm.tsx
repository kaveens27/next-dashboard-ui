// DESC: This will be the specific AttendanceForm component which will be rendered in the teacher page via the FormModal component
...
const AttendanceForm = ({type,data}:AttendanceFormProps) => {
    ...
    return (
        <form className='flex flex-col p-4 gap-4' onSubmit={onSubmit}>
            <h1 className='text-xl font-semibold mb-4'>{type ==='create' ? "Create A New Attendance" : "Update A Attendance" }</h1>
