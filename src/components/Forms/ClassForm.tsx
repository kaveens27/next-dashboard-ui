// DESC: This will be the specific ClassForm component which will be rendered in the teacher page via the FormModal component
...
const ClassForm = ({type,data}:ClassFormProps) => {
    ...
    return (
        <form className='flex flex-col p-4 gap-4' onSubmit={onSubmit}>
            <h1 className='text-xl font-semibold mb-4'>{type ==='create' ? "Create A New Class" : "Update A Class" }</h1>
